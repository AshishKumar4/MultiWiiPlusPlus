...
void Mag_init() {
 // i2c_writeReg(MAG_ADDRESS, 0x0A,0x80);
  i2c_writeReg(MAG_ADDRESS, 0x0B, 0x01);
  /*i2c_writeReg(MAG_ADDRESS, 0x20, 0x40);
  i2c_writeReg(MAG_ADDRESS, 0x21, 0x01);
  i2c_writeReg(MAG_ADDRESS, 0x09, 0x0D);*/
  //Define Set/Reset period
  //setMode(Mode_Continuous,ODR_200Hz,RNG_8G,OSR_512);
  i2c_writeReg(MAG_ADDRESS, MAG_CTRL_REG1, Mode_Continuous|ODR_200Hz|RNG_8G|OSR_512);
}
